...
class jjVersionInformation
{
 public:
  jjVersionInformation(jju32);

  jju8 processorType(void) const;
  jju8 family(void) const;
  jju8 model(void) const;
  jju8 steppingID(void) const;
